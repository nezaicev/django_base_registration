"""
Django settings for s_express project.
...
SECRET_KEY = 'django-insecure-ui5j99a1rgf@*y(&@*npn(6$k_i+_uj-qgh+58g)+kw8hdq8q%'
...
WSGI_APPLICATION = 's_express.wsgi.application'
